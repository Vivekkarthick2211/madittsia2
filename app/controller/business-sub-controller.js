const SubBusiness = require("../model/business-sub-model");
...
/* exports.findall = (req, res) => {
  ...
  exports.serviceOne = (req, res) => {
    SubBusiness.findById(req.params.maincategory, (err, data) => {
      ...
      if (err) {
        ...
        if (err.kind === "not_found") {
          ...
          res.status(500).send({
            message: "Error retrieving Customer with id " + req.params.maincategory +res.statusCode
          });
        }
      } 
